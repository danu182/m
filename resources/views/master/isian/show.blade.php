            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('isianpemeriksaan.store') }}" method="POST">
                                @csrf
                                {{-- @method("PUT") --}}
                               
                                <div class="form-group">
                                    <label for="">pemeriksaan_id</label>
                                    <input type class="form-control" type="text" name="pemeriksaan_id" value="{{ $pemeriksaan->id }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="">kategori isian</label>
                                    <input type class="form-control" type="text" name="kategori_isian" value="">
                                </div>
