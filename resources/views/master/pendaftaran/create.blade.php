        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="pull-left">
                     ...
                     {{-- <a href="" class="btn btn-outline-danger">form Tambah pendaftaran</a> --}}
                </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('pendaftaran.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nama_pendaftaran">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="peserta_id" id="peserta_id" class="form-control">
                                        @foreach ($peserta as $user)
                                            <option value="{{ $user->id }}">{{ $user->nama_peserta }}</option>
                                        @endforeach
                                    </select>
                                </div>
