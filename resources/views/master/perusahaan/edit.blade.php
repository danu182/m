                        ...
                        <div class="card-body">
                            <form action="{{ route('perusahaan.update',$perusahaan->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nama_perusahaan" value="{{ $perusahaan->nama_perusahaan }}">
                                </div>

                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">alamat_perusahaan</label>
                                    <textarea class="form-control" name="alamat_perusahaan" id="exampleFormControlTextarea1" rows="3">{{ $perusahaan->alamat_perusahaan }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="">tlp_perusahaan</label>
                                    <input class="form-control" type="text" name="tlp_perusahaan" value={{ $perusahaan->tlp_perusahaan }}>
                                </div>

                                <div class="form-group">
                                    <label for="">cp_perusahaan</label>
                                    <input class="form-control" type="text" name="cp_perusahaan" value="{{ $perusahaan->cp_perusahaan }}">
                                </div>
